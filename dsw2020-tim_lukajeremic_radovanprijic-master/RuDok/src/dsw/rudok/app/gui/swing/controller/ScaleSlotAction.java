...
public class ScaleSlotAction  extends AbstractRudokAction {

    public ScaleSlotAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK));
        putValue(SMALL_ICON, loadIcon("images/scale.png"));
        putValue(NAME, "Scale slot");
        putValue(SHORT_DESCRIPTION, "Scale slot");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        ((PageView) dv.getSelectedFrame()).startScaleState();
    }
}
